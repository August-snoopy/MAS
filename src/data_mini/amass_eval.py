...
class AMASSEval(data.Dataset):
    ...
    def _collect_all(self):
        ...
        for amass_seq_name in tqdm(self._amass_file_names):
            ...
            valid_frames = np.arange(0, T - self.amass_motion_input_length - self.amass_motion_target_length + 1,
                                     self.shift_step)
    ...
    def __getitem__(self, index):
        ...
        frame_indexes = np.arange(start_frame,
                                  start_frame + self.amass_motion_input_length + self.amass_motion_target_length)
